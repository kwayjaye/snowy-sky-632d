...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/snowy-sky-632d)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/snowy-sky-632d
```

A live public deployment of this template is available at [https://snowy-sky-632d.templates.workers.dev](https://snowy-sky-632d.templates.workers.dev)
